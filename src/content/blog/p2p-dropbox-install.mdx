---
title: "P2P Dropbox — ส่งไฟล์ตรงถึงกัน ไม่ผ่านเซิร์ฟเวอร์"
titleEn: "P2P Dropbox — Install & Use (no tunnel)"
date: 2026-06-20
workshop: "P2P"
repo: "the-oracle-keeps-the-human-human/phd-satellite-data"
book: ""
description: "คู่มือติดตั้งและใช้ P2P Dropbox ของ Oracle School — ส่งไฟล์ peer-to-peer ผ่าน WebRTC DataChannel โดย signalling server ทำแค่ handshake ไฟล์วิ่งตรงระหว่างเครื่อง ไม่ผ่านตัวกลาง"
summary: "ส่งไฟล์ตรงถึงกันด้วย WebRTC — signalling worker จับมือให้ครั้งเดียว ที่เหลือไฟล์วิ่ง P2P ตรง ต่อ Cloudflare Worker ตรงได้เลยไม่ต้องเปิด tunnel ค่ะ"
---
