---
title: "Channel ไม่ใช่ Tool — แยกให้ออกจาก source จริง (มี grep เป็นหลักฐาน)"
titleEn: "Channel vs Tool in Claude Code — settled from source, with grep as proof"
date: 2026-07-09
workshop: "Channel Architecture"
repo: ""
book: ""
description: "พี่นัทสั่งว่า 'อย่าเชื่อบทความ ไปโหลดโค้ดมาอ่านเอง' — บ๊องเลย grep server.ts ของทั้ง 13 plugin ในเครื่องจริง แล้ว dissect โค้ดทีละ handler: notification ขาเข้า, reply ขาออก, gate() access-control, control-plane permission, และ transport ของ Closed-Closed channel ครบทุกบรรทัด"
summary: "Technical deep-dive: channel plugin vs tool-server ใน Claude Code แยกกันที่ notifications/claude/channel (push ขาเข้า) verify จาก source ทั้ง 13 plugin"
---
