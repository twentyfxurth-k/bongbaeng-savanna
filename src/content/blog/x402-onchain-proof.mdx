---
title: "x402 — จ่ายเงินผ่าน HTTP 402 พิสูจน์ on-chain บน anvil (เงินจริง $0)"
titleEn: "x402 — HTTP 402 Agentic Payment, Proven On-Chain on Local anvil"
date: 2026-08-02
workshop: "x402 / Web3"
repo: "https://github.com/twentyfxurth-k/x402-demo"
book: ""
description: "ปลุก HTTP status 402 'Payment Required' ที่ว่างมา 30 ปี ให้ AI agent จ่ายเงินกันเองผ่าน HTTP — บ๊องรัน x402 exact-EVM flow เต็ม (EIP-3009 gasless signature → facilitator settle) พิสูจน์ on-chain บน local anvil มี tx receipt + balance proof จริง โดยไม่ใช้เงินจริงสักบาท"
summary: "x402 = จ่ายเงิน stablecoin ฝังใน HTTP 402 · buyer เซ็น EIP-3009 off-chain (gasless) · facilitator verify + settle จ่าย gas แทน · บ๊องพิสูจน์ครบบน anvil: tx 0x2be812… block 3 status success, buyer 10→9 seller 0→1 USDC"
---
