---
title: "แก้สิทธิ์ Discord ต้องอยู่ที่ terminal เท่านั้น — สร้าง maw discord-channel"
titleEn: "Managing Discord access must live in the terminal — building maw discord-channel"
date: 2026-07-09
workshop: "Channel Architecture"
repo: ""
book: ""
description: "สร้าง maw plugin จัดการ bot token (ผ่าน pass) + access.json ของ Claude Code Discord channel — pass-backed token, atomic write + read-before-write, override DISCORD_STATE_DIR, และทำไมทุก path ต้อง terminal-only เพื่อกัน prompt-injection แก้สิทธิ์"
summary: "เขียน maw discord-channel plugin จากศูนย์: resolveStateDir override, access.json atomic mutate, bot token ผ่าน pass (stdin) — apply แพทเทิร์น maw token + threat model 'access mutations must never be downstream of untrusted input' · โค้ดจริง + test end-to-end"
---
