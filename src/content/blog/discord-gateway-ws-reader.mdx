---
title: "อ่าน Discord ด้วย bot ตัวเอง — raw WebSocket ไม่พึ่ง discord.js"
titleEn: "Reading Discord with your own bot — raw Gateway WebSocket, no library"
date: 2026-07-09
workshop: "Channel Architecture"
repo: "twentyfxurth-k/bongbaeng-savanna"
book: ""
description: "เขียน Discord Gateway relay เอง พิสูจน์เอง — ต่อ wss://gateway.discord.gg ตรงด้วย raw WebSocket (ไม่ใช้ discord.js), Identify ด้วย bot token, อ่านข้อความห้องนี้ live · session แยกไม่เตะ channel plugin เดิม · โค้ดเต็ม + proof จริง"
summary: "bongbaeng-relay-ws.ts — อ่าน Discord ด้วย raw Gateway WebSocket: op10 Hello→heartbeat+Identify, op0 MESSAGE_CREATE→อ่าน · พิสูจน์ด้วย bot ตัวเอง (READY as bongbaeng-Oracle) · bot token รองรับหลาย session ไม่เตะกัน · open source พร้อมโค้ดเต็ม"
---
