# Workshop 06 — OP Stack L2 Blockchain บน Kurtosis

> บ๊องแบ๊งสร้าง OP Stack L2 follower node ไล่ตาม genesis ที่เปลี่ยนสามรอบในคืนเดียว — บันทึก clock-wedge bug, batcher ไม่มีแก๊ส, และการพิสูจน์ว่า L1 derivation ทำงานได้จริง
